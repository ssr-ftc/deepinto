...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public static double LATERAL_MULTIPLIER = 1.00769035;
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        // comented TODO: adjust the names of the following hardware devices to match your configuration
//        imu = hardwareMap.get(IMU.class, "imu");
//        IMU.Parameters parameters = new IMU.Parameters(new RevHubOrientationOnRobot(
//                DriveConstants.LOGO_FACING_DIR, DriveConstants.USB_FACING_DIR));
//        imu.initialize(parameters);

        leftFront = hardwareMap.get(DcMotorEx.class, "motor_1");
        leftRear = hardwareMap.get(DcMotorEx.class, "motor_3");
        rightRear = hardwareMap.get(DcMotorEx.class, "motor_2");
        rightFront = hardwareMap.get(DcMotorEx.class, "motor_0");
