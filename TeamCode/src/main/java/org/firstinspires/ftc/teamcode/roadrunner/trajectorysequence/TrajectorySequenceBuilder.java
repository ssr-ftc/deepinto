...
public class TrajectorySequenceBuilder {
    ...
    public TrajectorySequenceBuilder splineTo(Vector2d endPosition, double endHeading, int i, double v, double v1) {
...
//    public TrajectorySequenceBuilder splineToLinearHeading(Vector2d vector2d, double radians, int i, double v, double v1) {
//    }
